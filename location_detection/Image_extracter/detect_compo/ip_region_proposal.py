...
from config_image_extracter.CONFIG_UIED import Config
C = Config()


def enhance_contrast_grey(grey):
    """Enhance contrast using Histogram Equalization."""
    return cv2.equalizeHist(grey)

def adaptive_binarization(grey):
    """Apply adaptive thresholding to improve binarization."""
    return cv2.adaptiveThreshold(grey, 255, cv2.ADAPTIVE_THRESH_GAUSSIAN_C, cv2.THRESH_BINARY_INV, 11, 2)

def apply_morphology(binary):
    """Apply morphological operations to close small holes and gaps."""
